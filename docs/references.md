...
The course is built around the primary literature. Where possible, links go to the
NASA [ADS](https://ui.adsabs.harvard.edu/) record or the publisher DOI so you can read the
originals — many of these papers are short, readable, and historic.
...
- **Jansky, K. G. (1933).** *Electrical Disturbances Apparently of Extraterrestrial Origin.*
  Proc. IRE 21, 1387. — The birth of radio astronomy.
  [ADS](https://ui.adsabs.harvard.edu/abs/1933PIRE...21.1387J)
- **Reber, G. (1944).** *Cosmic Static.* ApJ 100, 279. — The first radio maps of the sky,
...
- **van de Hulst, H. C. (1945).** *Radiogolven uit het wereldruim* (Radio waves from space).
  Ned. Tijd. Natuurkunde 11, 201. — Predicted the 21 cm line.
...
### Pulsars & a cosmological diversion

- **Hewish, A., Bell, S. J., et al. (1968).** *Observation of a Rapidly Pulsating Radio Source.*
  Nature 217, 709. — The discovery of pulsars (Chapter 13).
  [DOI](https://doi.org/10.1038/217709a0)
...
- **Condon, J. J. & Ransom, S. M.** *Essential Radio Astronomy.* Princeton University Press.
  ...
  — The single best free companion to this course.
